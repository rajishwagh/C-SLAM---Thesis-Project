...
def matching5 (mat1, mat2, comp_var, user_match_perc) :   #finds percentage of matching and stores in a 4D matrix. 
    ...
    if high > user_match_perc :       #user_match_perc is a user defined value that defines the acceptable number
        ...
        #print 'm1', major1
        #print 'm2', major2
        mas = map_merge5(s, t, u, v, mat1, mat2, comp_var)
    else:
        return [0, mas[1]]
...
def map_merge5(a, b, c, d, mat1, mat2, comp_var):
...
#     if xmat1 != xmat2:
#         print 'They are not equal after map_merge. xmats not matching'
#         deal = 1000
...
# 
# #
def motion_deciding_function5(mat1, orient, rl, cl, afv ):
...
def var_update5(mat, row_next_pos, col_next_pos, row_cp_map, col_cp_map, row_cp_local, col_cp_local, orient, fv, afv):
...
def sel_random(a, n):   # Creates a list of n items randomly selected from agv list
    list = [[0 for x in range(11)] for y in range(n)]
    ag = copy.deepcopy(a)
    for i in range(n):
        random.shuffle(ag)
        list[i] = ag.pop()
